...
export const JoinGroupIcon = props => <Icon {...props} icon="people-group" />;
export const LabsIcon = props => <Icon {...props} icon="laptop" />;
export const LectureIcon = props => <Icon {...props} icon="person-chalkboard" />;
